...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-warning fw-bold">add to cart <i class="fas fa-shopping-cart"></i></button>
      <button id="details-btn" class="btn btn-info fw-bold">Details</button></div>
      `;
